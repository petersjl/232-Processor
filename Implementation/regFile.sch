...
<drawing version="7">
    ...
    <netlist>
        ...
        <block symbolname="decode4b16" name="XLXI_55">
            ...
            <blockpin signalname="O8" name="O1" />
            <blockpin signalname="O1" name="O2" />
            <blockpin signalname="O9" name="O3" />
            <blockpin signalname="O10" name="O5" />
            <blockpin signalname="O11" name="O6" />
            <blockpin signalname="O15" name="O15" />
            <blockpin signalname="O7" name="O14" />
            <blockpin signalname="O13" name="O11" />
            <blockpin signalname="O12" name="O9" />
            <blockpin signalname="O4" name="O8" />
            <blockpin signalname="O2" name="O4" />
            <blockpin signalname="O6" name="O12" />
            <blockpin signalname="O5" name="O10" />
            <blockpin signalname="O3" name="O7" />
            <blockpin signalname="O14" name="O13" />
        </block>
